...
export const Footer = () => {
  ...
  return (
    <footer className="font-['Montserrat',sans-serif] text-gray-300 border-t border-white/10" style={{ backgroundColor: '#0B1A30' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 lg:py-18">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 xl:gap-20 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col items-center lg:items-start text-center lg:text-left space-y-6">
            <Link to="/home" className="flex items-center gap-3 hover:opacity-95 transition-opacity">
              <img src="/assets/logo_icon.png" alt="Celina Icon" className="h-14 w-auto rounded-full object-contain bg-white/5 p-1" />
              <img src="/assets/logo_text.png" alt="Celina Clothing" className="h-10 w-auto object-contain" />
            </Link>
            
            <p className="text-gray-300 text-sm sm:text-[15px] leading-relaxed max-w-md">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-8 w-full">
            
            {/* 1. Company */}
            <div className="flex flex-col space-y-4">
              <div className="flex justify-between items-center pb-2 border-b border-white/10 sm:border-transparent">
                <h4 className="text-white font-bold uppercase tracking-[0.16em] text-sm sm:text-[15px] font-['Cinzel',serif] text-[#D4AF37]">
                  Company
                </h4>
                <button
              ...
              <ul className={`space-y-3 text-sm sm:text-[15px] font-medium transition-all duration-300 ${activeSection === 'company' ? 'block' : 'hidden sm:block'}`}>
                <li>
                ...
                <li>
                  <Link to="/support" className="text-gray-300 hover:text-[#D4AF37] transition-colors">
                    Support
                  </Link>
                </li>
                <li>
                  <Link to="/careers" className="text-gray-300 hover:text-[#D4AF37] transition-colors">
                    Careers
                  </Link>
                </li>
              </ul>
            ...
            <div className="flex flex-col space-y-4">
              ...
              <ul className={`space-y-3 text-sm sm:text-[15px] font-medium transition-all duration-300 ${activeSection === 'quick-link' ? 'block' : 'hidden sm:block'}`}>
                <li>
                  <Link to="/shop" className="text-gray-300 hover:text-[#D4AF37] transition-colors">
                    All Collections
                  </Link>
                </li>
                <li>
                  <Link to="/home#best-sellers" className="text-gray-300 hover:text-[#D4AF37] transition-colors">
                    Best Sellers
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/faqs" className="text-gray-300 hover:text-[#D4AF37] transition-colors">
                    FAQs
                  </Link>
                </li>
              </ul>
            ...
            <div className="flex flex-col space-y-4">
              ...
              <ul className={`space-y-3 text-sm sm:text-[15px] font-medium transition-all duration-300 ${activeSection === 'legal' ? 'block' : 'hidden sm:block'}`}>
                <li>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-white/10 mt-14 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs sm:text-sm text-gray-400">
          <p>
