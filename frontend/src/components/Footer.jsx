            ...
            <div className="flex items-center gap-3 pt-2">
              {settings?.socialFacebook && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#B08D57] hover:text-white flex items-center justify-center transition-all duration-300 text-gray-300"
                  aria-label="Facebook"
                >
